...
struct ICertificatePolicy_t455;
...
struct  ServicePointManager_t456  : public Object_t
{
};
struct ServicePointManager_t456_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t414 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t441 * ___server_cert_cb_9;
};
