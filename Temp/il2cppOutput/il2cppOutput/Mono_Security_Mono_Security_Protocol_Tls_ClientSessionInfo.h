...
struct  ClientSessionInfo_t703  : public Object_t
{
	...
	ByteU5BU5D_t131* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t131* ___masterSecret_5;
};
struct ClientSessionInfo_t703_StaticFields{
