...
struct  X509Store_t486  : public Object_t
{
	...
	X509Certificate2Collection_t477 * ___list_2;
	...
	X509Store_t500 * ___store_4;
};
struct X509Store_t486_StaticFields{
	...
	Dictionary_2_t110 * ___U3CU3Ef__switchU24mapF_5;
};
