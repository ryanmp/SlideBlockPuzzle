...
struct  ThreadSafeDictionary_2_t380  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t379 * ____valueFactory_1;
	...
	Dictionary_2_t1637 * ____dictionary_2;
};
